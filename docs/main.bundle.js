...
class GraphNode {
    ...
    execute(code_generator, modules, print) {
        ...
        this.getOutputs().map(function (o) {
            if (o.isFunction()) {
                let node_code = code_generator.getNodeCode(self);
